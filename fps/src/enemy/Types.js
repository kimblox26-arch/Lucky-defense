...
export const TYPES = [
  {
    ...
    damage: 11, attackRange: 1.5, attackWind: 0.42, attackCd: 1.15,
    radius: 0.34, height: 1.78, mass: 1,
    staggerResist: 0, knockback: 1.0,
    color: '#5d6b4e', accent: '#3f4936', eye: '#ff5a2a', eyeIntensity: 2.6,
    scale: [1, 1, 1, 1, 1],
    score: 100, gore: 6,
  },
  {
    ...
    damage: 8, attackRange: 1.45, attackWind: 0.24, attackCd: 0.72,
    radius: 0.3, height: 1.66, mass: 0.7,
    staggerResist: 0, knockback: 1.5,
    color: '#7a4438', accent: '#4d2a22', eye: '#ffdc3a', eyeIntensity: 4.0,
  ...
  },
  {
    ...
    color: '#4a4f56', accent: '#2c3036', eye: '#ff2a1a', eyeIntensity: 3.2,
  ...
  },
  {
    ...
    color: '#4c6b52', accent: '#2f4434', eye: '#7dff5c', eyeIntensity: 2.3,
  ...
  },
  {
    ...
    color: '#7b6a2c', accent: '#4a3f18', eye: '#ff8c1a', eyeIntensity: 3.4,
